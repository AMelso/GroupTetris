    ...
    return (
        ...
        <div className="col-md-3">
                    <div className="list-group ">
                        ...
                        <Link to="/score-board" className={location.pathname === "/score-board" ? "list-group-item list-group-item-action active" : "list-group-item list-group-item-action"}>Score Board</Link>
